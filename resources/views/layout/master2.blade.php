...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 434px;">
    <!-- Brand Logo -->
    <a href="{{ url('j_index') }}" class="brand-link">
    ...
    <div class="sidebar">
        <div>
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{ url('j_view') }}/{{ Auth::user()->id }}" class="d-block">{{ Auth::user()->name }}</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <!-- Add icons to the links using the .nav-icon class
                         ...
                         <li class="nav-item">
                            <a href="{{ route('categ') }}" class="nav-link">
						 ...
						 <li class="nav-item">
                            <a href="{{ route('j_regcase') }}" class="nav-link">
                                <i class="nav-icon fa fa-calendar"></i>
                                <p>
                                    ادارةالمواد المرفوض
						 ...
						 <li class="nav-item">
                            <a href="{{ route('s_topic') }}" class="nav-link">
                                <i class="nav-icon fa fa-calendar"></i>
                                <p>
                                    المحفوظات
