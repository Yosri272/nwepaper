    ...
    <div class="sidebar">
        <div>
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{ url('a_view') }}/{{ Auth::user()->id }}" class="d-block">{{ Auth::user()->name }}</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <!-- Add icons to the links using the .nav-icon class
                         with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item">
                                <a href="{{ url('d_topic') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                            <a href="{{ url('a_display1') }}" class="nav-link">
                                <i class="nav-icon fa fa-calendar"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('a_display2') }}" class="nav-link">
                                <i class="nav-icon fa fa-calendar"></i>
                                <p>
                                    مقالات تحت التصحيح
                        ...
                        <li class="nav-item">
                            <a href="{{ url('a_display') }}" class="nav-link">
                                <i class="nav-icon fa fa-calendar"></i>
                                <p>
                        ...
                        <li class="nav-item">
                                <a href="{{ route('a_regcase') }}" class="nav-link">
                                    <i class="nav-icon fa fa-calendar"></i>
                                    <p>
                                       ادارة المواد المرفوضة

                                    </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('jointopd') }}"  class="nav-link">
                                    <i class="nav-icon fa fa-calendar"></i>
                                    <p>
                                        المهام
                            ...
                            <li class="nav-item">
                               <a  href="{{ url('c_register') }}" class="nav-link">
                                    <i class="nav-icon fa fa-calendar"></i>
                                    <p>
                                       اضافة الاعضاء
                            ...
                            <li class="nav-item">
                                <a href="{{ url('category1') }}" class="nav-link">
                                    <i class="nav-icon fa fa-calendar"></i>
                                    <p>
