...
<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav mr-auto">
      <!-- Messages Dropdown Menu -->
           <li style="margin-left: 200px;"> <a href="{{ url('e_pssword6') }}">تغير كلمة السر </a></li>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 434px;">
    <!-- Brand Logo -->
    <a href="{{ url('s_index') }}" class="brand-link">
    ...
    <div class="sidebar">
        <div>
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{ url('s_view') }}/{{ Auth::user()->id }}" class="d-block">{{ Auth::user()->name }}</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <!-- Add icons to the links using the .nav-icon class
                        ...
                        <li class="nav-item">
                            <a href="{{ url('s_display1') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('s_display2') }}" class="nav-link">
                                <i class="nav-icon fa fa-calendar"></i>
                                <p>
                                    مقالات تحت التصحيح
                        ...
                        <li class="nav-item">
                            <a href="{{ url('s_display') }}" class="nav-link">
                                <i class="nav-icon fa fa-calendar"></i>
                                <p>
