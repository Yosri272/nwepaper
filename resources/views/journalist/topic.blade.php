...
<div class="card card-warning">
              ...
              <!-- /.card-header -->
                ...
                <form action="{{ url('topicStort')}}"  method="GET"> 
                 <!-- <form method="GET">   -->
              @csrf
                  <!-- text input -->
                  <div class="form-group">
                    <label>عنوان المقال</label>
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="t_address" value="{{ old('name') }}" required autocomplete="name" autofocus>
...
<option>{{$data->c_name }}</option>
 ...
 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>المحتوي</label>
                    <textarea id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="t_body" value="{{ old('name') }}" required autocomplete="name" autofocus></textarea>
