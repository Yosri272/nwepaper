...
<div class="row"  class="content-wrapper" style="min-height: 434px;">
  ...
  <br>
  <form action="{{ url('category1Stort')}}" method="GET">
              @csrf
...
<div  class="a" class="content-wrapper" style="min-height: 434px;">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">الفات الفرعية</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    @foreach($category1Data as $data)
                    
                      <td> {{$data->id}}</td>
                      <td>{{$data->c_name}}</td>
                      <td>
                      <button class="btn btn-danger" ><a href="{{  url('Delcategory1')  }}/{{  $data->id  }}">حذف</a></button>
                       </td>
                       </tr>
                       @endforeach
                  </tbody>
